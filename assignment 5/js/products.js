...
window.products = [
  ...
  },
  {
    id: "gamep5",
    title: "God of War",
    description: "action-adventure game, fights to survive and teaches his son to do the same",
    price: 5999,
    imageUrl: "./img/gof.jpg",
    discontinued: false,
    categories: ["gamec5"]
  },
  {
    ...
    price: 4549,
    imageUrl: "./img/syberia.jpg",
    discontinued: false,
    categories: ["gamec5"]
  },
  {
    id: "gamep7",
    title: "Syberia: The World Before deluxe",
    description: "classic-adventure game, singleplayer and multiplayer",
    price: 5668,
    imageUrl: "./img/syberia.jpg",
    discontinued: false,
    categories: ["gamec5"]
  ...
  {
    id: "gamep8",
    title: "NBA 2K21 stadard edition",
    description: "best basketball gameplay with multiple formats to play, single and multiplayer",
    price: 7999,
    imageUrl: "./img/nba.jpg",
    discontinued: false,
    categories: ["gamec3", "gamec4", "gamec5"]
  },
  {
    id: "gamep9",
    title: "NBA 2K21 Mamba Forever",
